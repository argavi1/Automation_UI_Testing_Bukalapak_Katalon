...
WebUI.setText(findTestObject('Accounts_Page/passwordInput'), '12345678')

WebUI.click(findTestObject('Accounts_Page/loginButton'))

WebUI.verifyElementText(findTestObject('Accounts_Page/passwordsalahMessage'), 'Password yang kamu masukkan salah. Silakan coba lagi.')
